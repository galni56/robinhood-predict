...
keeper/frontend binding is pending. The pre-canary native deployment
...
`1790352582`. The corrected keeper resolved #0 from the signed timestamp
`1790352581` and cancelled #1. Finalization paid `0.000198 ETH` to the YES winner,
refunded `0.0002 ETH`, accrued `0.000002 ETH`, and left exactly that fee in the
contract. All eleven canary receipts and final public accounting reads passed.
