...
| Piece | Status |
|---|---|
| `PredictionMarket` contract | Native-ETH successor is deployed/configured at `0xe6C4aAf95f43E35Ef309eEa61bAfb345226333EB`; canary and public binding are pending. The USDG contracts at `0x1a62098AcEd3F7F8C41fff1bc1395A541678b0F1` and `0xd95ed19edBCd330498CADe7BA8569ac940A4182f` contain only owner tests and are unsupported history. 43/43 focused Foundry tests pass. |
