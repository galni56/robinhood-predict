...
| Piece | Status |
|---|---|
| `PredictionMarket` contract | Corrected native-ETH candidate is deployed/configured at `0x4bfd0efc15C3198fe3AFf4741FF121AB2F38060e`; it requires funded YES/NO pools and two distinct participant addresses. The unused pre-canary native address `0xe6C4aAf95f43E35Ef309eEa61bAfb345226333EB` is superseded. The USDG contracts at `0x1a62098AcEd3F7F8C41fff1bc1395A541678b0F1` and `0xd95ed19edBCd330498CADe7BA8569ac940A4182f` contain only owner tests and are unsupported history. 46/46 focused Foundry tests pass. |
