...
| Piece | Status |
|---|---|
| `PredictionMarket` contract | The first native-ETH deployment at `0xe6C4aAf95f43E35Ef309eEa61bAfb345226333EB` was superseded before canary because it only required funded YES/NO pools. The corrective candidate also requires two distinct participant addresses and must be redeployed/configured before canary. The USDG contracts at `0x1a62098AcEd3F7F8C41fff1bc1395A541678b0F1` and `0xd95ed19edBCd330498CADe7BA8569ac940A4182f` contain only owner tests and are unsupported history. 46/46 focused Foundry tests pass. |
...
| Markets | The 11 USDG markets are historical owner tests. Native `createMarket` remains permissionless for the 10 configured pool assets on the deployed successor; no native market has been created yet because the tiny-value canary is pending. |
