...
| Piece | Status |
|---|---|
| `PredictionMarket` contract | Corrected native-ETH candidate is deployed/configured at `0x4bfd0efc15C3198fe3AFf4741FF121AB2F38060e`; it requires funded YES/NO pools and two distinct participant addresses. Its two-market tiny-value canary is live and awaiting the deadline settlement/claim/refund phase. The unused pre-canary native address `0xe6C4aAf95f43E35Ef309eEa61bAfb345226333EB` is superseded. The USDG contracts at `0x1a62098AcEd3F7F8C41fff1bc1395A541678b0F1` and `0xd95ed19edBCd330498CADe7BA8569ac940A4182f` contain only owner tests and are unsupported history. 46/46 focused Foundry tests pass. |
...
| Markets | The 11 USDG markets are historical owner tests. Native `createMarket` remains permissionless for the 10 configured pool assets. Canary markets #0/#1 are open on the corrected successor with deadline `1790352582`; public frontend binding remains disabled. |
